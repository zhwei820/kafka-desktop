  ...
  methods: {
    ...
    editorHasLoaded(editor, monaco) {
      ...
      this.editor.onDidChangeCursorSelection((event) =>
        this.cursorSelectionChangeHandler(editor, event)
      );
    ...
    cursorSelectionChangeHandler: function (editor) {
      if (this.selectionChangeEmitter) {
        this.selectionChangeEmitter(editor);
      } else {
        this.selectionChangeEmitter = debounce(function (editor) {
